      ...
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-start gap-2.5 mb-8 p-3.5 rounded-xl bg-amber-500/8 border border-amber-500/20">
          ...
          <div className="text-sm text-amber-300/80 leading-relaxed">
            ...
            CVR figures are modeled from industry benchmarks (Reforge, Amplitude 2024) and behavioral economics 
        ...
        <div className={`mb-8 transition-all duration-700 ${animateIn ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}>
          ...
          <div className="flex items-center gap-2 mb-3 flex-wrap">
            ...
            <a href="/case-study" className="text-sm text-slate-500 hover:text-blue-400 flex items-center gap-1 transition-colors">
              EXP-A (Ad Format) <ChevronRight className="h-3 w-3" />
            </a>
            <a href="/case-study" className="text-sm text-slate-500 hover:text-green-400 flex items-center gap-1 transition-colors">
          ...
          <p className="text-slate-400 max-w-2xl text-sm leading-relaxed">
            ...
            Guardrail: paywall dismissal rate must not increase &gt;5pp above baseline.
          </p>
          <p className="text-slate-500 text-xs mt-2 leading-relaxed">
            Context: EXP-C only activates at WMS ≥ 65, where estimated subscription LTV exceeds the CPM value 
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-slate-400 text-xs leading-relaxed">
                weather.com serves ~360M MAU. At a conservative 50M US users/month and ~15% in severe+ conditions 
        ...
        <div className={`grid grid-cols-3 gap-4 mb-6 transition-all duration-700 delay-100 ${animateIn ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}>
          <BigStat label="Control CVR" value="2.1%" sub="Generic copy, all gated sessions" color="#64748b" icon={BarChart3} />
          <BigStat label="Contextual CVR" value="4.0%" sub="Named conditions, WMS ≥ 65" color="#3b82f6" icon={TrendingUp} />
        ...
        <div className={`glass rounded-2xl p-6 mb-6 transition-all duration-700 delay-300 ${animateIn ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}>
          <h3 className="text-sm font-semibold text-slate-400 uppercase tracking-wider mb-1">CVR by WMS Segment</h3>
          <p className="text-xs text-slate-600 mb-5">Lift scales with WMS — confirms the severity-gating logic</p>
              ...
              return (
                <div key={row.segment}>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="text-[10px] text-slate-600">{row.guard}</div>
                  </div>
                </div>
              );
            })}
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-slate-400 text-sm leading-relaxed">
                ...
                more long-term RPV through daily return visits than a premium conversion at that intent level.
        ...
        <div className={`glass rounded-2xl p-5 border border-purple-500/12 mb-8 transition-all duration-700 delay-450 ${animateIn ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}>
          ...
          <div className="space-y-2">
            <NextExperiment
              ...
              next="Scale EXP-C to all WMS ≥ 65 sessions globally. Begin EXP-D: test whether copy personalization beyond severity (mentioning the specific storm name or impact) lifts CVR further."
              color="#22c55e"
            />
            <NextExperiment
  ...
  return (
    <div className="glass rounded-xl p-3 border border-white/5">
      ...
      <div className="flex items-start gap-2 pl-10">
        ...
        <div className="text-xs text-slate-400 leading-relaxed">{next}</div>
      </div>
    </div>
  );
}
